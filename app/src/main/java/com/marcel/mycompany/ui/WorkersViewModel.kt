...
import com.marcel.mycompany.util.Event
...
class WorkersViewModel @ViewModelInject constructor (private val repository: RepositoryCl, @Assisted private val savedStateHandle: SavedStateHandle) : ViewModel() {
